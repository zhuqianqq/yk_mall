...
function queryByPage(p){
	...
	params.page = p;
	$.post(WST.U('store/orderservices/pageQuery'),params,function(data,textStatus){
		$('#loading').hide();
...
function refund(){
    ...
    $.post(WST.U("store/orderservices/dealRefund"),postData,function(res){
...
function commit(){
    ...
    $.post(WST.U("store/orderservices/dealApply"),postData,function(res){
        var json = WST.toJson(res);
        WST.msg(json.msg);
        if(json.status==1){
            return goBack();
...
function receive(p){
    ...
    $.post(WST.U('store/orderservices/shopReceive'),postData,function(res){
        var json = WST.toJson(res);
        WST.msg(json.msg);
        if(json.status==1){
            return goBack();
...
function send(p){
    ...
    $.post(WST.U('store/orderservices/shopSend'),postData,function(res){
        var json = WST.toJson(res);
        WST.msg(json.msg);
        if(json.status==1){
            return goBack(p);
