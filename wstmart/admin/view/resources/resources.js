...
function initGrid(p){
   ...
   var cols = [
            {title:'资源文件', name:'resPath', width: 50, renderer: function(val,item,rowIndex){
				if(item['resType']==0){
					return "<span class='weixin'><img id='img' onmouseout='toolTip()' onmouseover='toolTip()' style='height:50px;width:50px;' src='"+item['resPath']
					+"'><span class='imged' ><img  style='height:180px;width:180px;' src='"+item['resPath']+"'></span></span>";
