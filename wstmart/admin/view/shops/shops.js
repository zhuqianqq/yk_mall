	...
	WST.upload({
			...
			callback:function(f){
				...
				if(json.status==1){
				    ...
				    $('#legalCertificateImgPreview_a').attr('href',json.url);
	...
	WST.upload({
			...
			callback:function(f){
				...
				if(json.status==1){
					...
					$('#businessLicenceImgPreview_a').attr('href',json.url);
	...
	WST.upload({
			...
			callback:function(f){
				...
				if(json.status==1){
					...
					$('#bankAccountPermitImgPreview_a').attr('href',json.url);
	...
	WST.upload({
			...
			callback:function(f){
				...
				if(json.status==1){
					...
					$('#organizationCodeImgPreview_a').attr('href',json.url);
	...
	WST.upload({
			...
			callback:function(f){
				...
				if(json.status==1){
					...
					$('#taxpayerQualificationImgPreview_a').attr('href',json.url);
