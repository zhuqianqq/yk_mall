...
function initSaleGrid(p){
    ...
    var cols = [
            {title:'&nbsp;', name:'goodsImg', width: 20, renderer: function(val,item,rowIndex){
            	...
            	return "<span class='weixin'><img id='img' onmouseout='toolTip()' onmouseover='toolTip()' style='height:50px;width:50px;' src='"+thumb
...
function initAuditGrid(p){
    ...
    var cols = [
            {title:'&nbsp;', name:'goodsName', width: 20, renderer: function(val,item,rowIndex){
            	return "<span class='weixin'><img class='img' style='height:50px;width:50px;' src='"+item['goodsImg']+"'><img class='imged' style='height:200px;width:200px;' src='"+item['goodsImg']+"'></span>";
            }},
