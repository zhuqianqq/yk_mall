...
function initGrid(p){
   ...
   var cols = [
       {title:'商品图片', name:'goodsName', width: 30,renderer:function(val,item,rowIndex){
               ...
               html.push("<span class='weixin'><img class='img' style='height:50px;width:50px;' src='"+item['goodsImg']+"'><img class='imged' style='height:200px;width:200px;max-width: 200px;max-height: 200px;' src='"+item['goodsImg']+"'></span></a></div>");
               return html.join('');
           }},
