...
function initGrid1(p){
    ...
    var cols = [
            {title:'&nbsp;', name:'goodsImg', width: 50, renderer: function(val,item,rowIndex){
                ...
                return "<span class='weixin'><img id='img' onmouseout='toolTip()' onmouseover='toolTip()' style='height:50px;width:50px;' src='"+ item['goodsImg']
            	+"'><span class='imged' ><img  style='height:180px;width:180px;' src='"+thumb+"'></span></span></span>";
            }},
